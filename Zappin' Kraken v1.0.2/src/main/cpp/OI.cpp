...
OI::OI() {  
  LimelightShootButton.ToggleWhenPressed(new ManualLimelightShoot);

  FlipIntakePositionButton.WhenPressed(new SetDesiredIntakePosition(kIntakeFlipperToggle));
  IntakeMidPositionButton.WhenPressed(new SetDesiredIntakePosition(kIntakeFlipperMidToggle));
  RunShooterButton.ToggleWhenPressed(new ShooterPID);

  RaiseElevatorButton.WhenPressed(new ElevatorPID(kElevatorTarget));
  ActuateElevatorBrakeButton.WhenPressed(new ActuateElevatorBrake);
