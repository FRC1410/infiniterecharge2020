...
void Robot::RobotPeriodic() {
  ...
  frc::SmartDashboard::PutBoolean("Lock State", m_elevator.GetLock());
  ...
  frc::SmartDashboard::PutNumber("Vertical Ball Count", m_storage.GetBallCount());
...
void Robot::AutonomousInit() {
  ...
  m_intake_flipper.ResetAngle();
  m_elevator.SetLock(true);

  m_autonomous_command = autos[4];//autos[(int) auto_chooser_entry.GetDouble(0)];
