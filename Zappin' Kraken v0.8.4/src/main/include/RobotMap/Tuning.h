...
//Intake
constexpr double kIntakeSpeedAdjustment = 0.6;
...
//Storage
constexpr double kStorageHorizontalSpeed = 0.6;
constexpr double kStorageVerticalSpeed = 0.6;

constexpr double kStorageFeedShooterHorizontalSpeed = 0.6;
...
constexpr double kShooterRPMProfiles[] = {3250, 3800, 4414};
