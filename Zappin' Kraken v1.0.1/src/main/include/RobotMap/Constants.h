...
constexpr double kOperatorTriggerThreshold = 0.5;  //Minimum Trigger Value
...
constexpr int kControlPanelTertiaryOffset = 3;     //Red field, yellow robot is offset of 1
...
constexpr int kShootDelay1 = 1;                    //Seconds after start of match
constexpr int kShootDelay2 = 2;                    //Seconds after start of match