...
void Storage::SetAutonomouslyRunning(bool running_input) {
  running = running_input;
}

bool Storage::GetAutonomouslyRunning() {
  return running;
}
...
void Storage::SetOuttakeRan(bool ran) {
  outtake_ran = ran;
}

bool Storage::GetOuttakeRan() {
  return outtake_ran;
}

void Storage::SetShooting(bool shooting_input) {
  shooting = shooting_input;
}

bool Storage::GetShooting() {
  return shooting;
}